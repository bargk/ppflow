...
TH1D *h_lb_tmp[2][4];
void ratioZdc(const int a ,const char* fileList, int Trig1 = 0){
    //load the bad lumiblocks
    TFile *finput = new TFile("/gpfs0/citron/users/bargl/ZDC/lhcf22/ppflow/badLB.root",read);
    h_lb_tmp[0][2]= (TH1D*)->finput->Get("h0_2");
    ...
    directory = Form("/gpfs0/citron/users/bargl/ZDC/lhcf22/ppflow/Rootfiles/Amp");
