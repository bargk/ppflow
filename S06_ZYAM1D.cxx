      ...
      for (int ipt2:pt2_bins){
         ...
         for (int ich:ch_bins){
            for (int ieta:deta_bins){
              ...
              sprintf(name,"PTY_ZYAM_cent%.2d_pta%d_ptb%.2d_ch%d_deta%.2d",icent,ipt1,ipt2,ich,ieta);
              PTY->SetName(name);
              output2->cd();
              PTY->Write();
              //-------------------------------------------------------------------------
              ...
              */
              ...
              sprintf(name,"h_ZYAM_Summary_cent%.2d_pta%d_ptb%.2d_ch%d_deta%.2d",icent,ipt1,ipt2,ich,ieta);
